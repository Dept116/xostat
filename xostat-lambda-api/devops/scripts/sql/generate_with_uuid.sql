...
ALTER TABLE ONLY public.build_parts ALTER COLUMN build_id SET DEFAULT uuid_generate_v4();
...
ALTER TABLE ONLY public.builds ALTER COLUMN id SET DEFAULT uuid_generate_v4();
...
ALTER TABLE ONLY public.match_players ALTER COLUMN id SET DEFAULT uuid_generate_v4();
...
ALTER TABLE ONLY public.round_players ALTER COLUMN id SET DEFAULT uuid_generate_v4();
...
ALTER TABLE ONLY public.rounds ALTER COLUMN id SET DEFAULT uuid_generate_v4();
