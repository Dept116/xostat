...
handler_wrapper_kwargs = {'function_name': 'xostat-lambda-api-dev-getUploadRecords', 'timeout': 30}
try:
    user_handler = serverless_sdk.get_user_handler('python/controllers/player.get_upload_records')
