...
handler_wrapper_kwargs = {'function_name': 'xostat-lambda-api-dev-uploadMatch', 'timeout': 30}
try:
    user_handler = serverless_sdk.get_user_handler('python/controllers/upload.upload_matches')
